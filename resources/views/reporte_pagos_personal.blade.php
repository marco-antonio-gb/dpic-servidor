...
$curso_postgrad="MAESTRIA EN ENERGIA RENOVABLE Y EFICIENCIA ENERGÉTICA";
...
<body>
    ...
    <div>
        ...
        <p class="m-0 p-0" style="margin-bottom: 5px !important"><strong>PROGRAMA DE POSTGRADO: </strong> {{ $curso_postgrad }}
        </p>
        <table>
            <thead>
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center ">1254121</td>
                <td class="text-center ">2016-12-12</td>
              </tr>
              <tr>
                <td class="text-center ">2</td>
                <td class="text-center ">1er PAGO</td>
                <td class="text-center ">2.500,00</td>
                <td class="text-center ">1254121</td>
                <td class="text-center ">2016-12-12</td>
              </tr>
